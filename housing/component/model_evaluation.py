...
from housing.util.util import load_object,load_data,read_yaml_file,write_yaml_file
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        try:
            ...
            if metric_info_artifact.index_number==1:
                ...
                logging.info(f"Trained model is not better than existing model hence not accepting trained model.")
